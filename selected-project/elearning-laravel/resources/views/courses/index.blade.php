...
@section('content')
    <section class="page-heading split-heading">
        <div>
            ...
            <p>Parcourez les cours publiés et filtrez selon votre objectif d'apprentissage.</p>
        </div>
        <a href="{{ route('categories.index') }}" class="button-link">Voir les catégories</a>
    </section>
    ...
    <form method="GET" action="{{ route('courses.index') }}" class="filter-panel">
        ...
        <div class="filter-row">
            ...
            <label>
                Niveau
                <input type="text" name="niveau" value="{{ $filters['niveau'] ?? '' }}" placeholder="Débutant">
            </label>
        ...
        <section class="course-grid">
            @foreach ($courses as $cours)
                <article class="course-card">
                    <p class="eyebrow">{{ $cours->categorie?->nom ?? 'Sans catégorie' }}</p>
